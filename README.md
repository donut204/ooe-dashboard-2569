...
ปีการศึกษา **2569 ภาคการศึกษา 1** โดยเชื่อมข้อมูลจาก Google Sheets ที่เผยแพร่ในรูปแบบ CSV และแสดงผลผ่านหน้าเว็บแบบ Static HTML
...
| **Podcast** | ติดตามจำนวนและสถานะ Podcast ในแต่ละรายวิชา | `podcast.html` |
...
- [Podcast Dashboard](https://donut204.github.io/ooe-dashboard-2569/podcast.html)
...
| `Podcast_Public` | Podcast Dashboard |
